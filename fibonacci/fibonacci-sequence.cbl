       ...
       PROCEDURE DIVISION.
           000-START-PROGRAM.
           Display "What place of the Fibonacci Sequence would you like" 
           "(<173)? " with no advancing.
           ...
           If DESIRED-COUNT is less than 2
             ...
             Unstring FORMATTED-RESULT delimited by all spaces into 
             FORMATTED-SPACE,FORMATTED-RESULT
